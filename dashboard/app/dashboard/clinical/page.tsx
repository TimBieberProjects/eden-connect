      ...
      <div className="mt-8">
        <div>
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="px-2.5 py-0.5 text-xs font-semibold bg-green-100 text-green-700 border border-green-200 rounded-full">Live</span>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-slate-800">Connect to Goroka General Hospital</h3>
                <p className="text-xs text-slate-500 mt-0.5">Get specialist support via Google Meet video call. Available Mon–Fri 8am–5pm.</p>
              </div>
              <div className="w-2.5 h-2.5 rounded-full bg-green-400 flex-shrink-0 ml-4" title="Available" />
            </div>
