...
export default function TelehealthPage() {
  ...
  return (
    <div className="bg-eden-pale-blue min-h-full">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-xl font-bold text-navy">Telehealth</h1>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={step} className="text-center">
                <div className="w-8 h-8 rounded-full bg-eden-teal/15 text-navy font-bold text-sm flex items-center justify-center mx-auto mb-2">{step}</div>
          ...
          {summary ? (
            <div className="bg-slate-50 rounded-lg border border-slate-200 p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  onClick={handleCopy}
                  className={`flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg transition ${copied ? 'bg-green-100 text-green-700' : 'bg-eden-teal/15 text-navy hover:bg-eden-teal/25'}`}
                >
                  {copied ? (
            ...
            <div className="bg-slate-50 rounded-lg border border-slate-200 p-4 text-center">
              ...
              <a href="/dashboard/clinical" className="inline-block mt-2 text-xs text-navy hover:underline font-medium">Go to Clinical Copilot →</a>
            </div>
          )}
